var VET_IfVer="04.00.06.04",
VET_newID=0,
VET_ch,
VET_Ap=navigator.appName,
VET_Bv=parseInt(navigator.appVersion.substring(0,1)),
VET_Iv=navigator.appVersion.indexOf("MSIE ")+5,
VET_Iv=parseInt(navigator.appVersion.substring(VET_Iv,VET_Iv+1)),
VET_Ag=navigator.userAgent.toLowerCase(),
VET_IE=VET_Ap=="Microsoft Internet Explorer"&&(VET_Iv>=5),
...
VET_Ic="IAtmosphere",VET_Cf="ComponentFileName",
VET_No_Plugin="http://cole.viewpoint.com/~ddavies/images/1x1transparent.gif"
...
MTSPlugin.prototype.createParams=function(pi){this.newParamString=""
	var cMV="50334504",gMV="50334504";this.LN=VET_Ln;var parms=""
	var hMV="50334504"
...
function MTSPlugin(file,width,height,bkey,alt,parmsc){
	...
	if((((str.toLowerCase()==VET_Ln))||((GetCookie(na)=="1")))&&((!(this.popUp=="1"))||(str.toLowerCase()==VET_Ln))||(VET_IsIn)){
		if(VET_Win&&VET_IE){var ch=""
			...
			var cbURL="https://components.viewpoint.com/adobe/MTSInstallers/MetaStream3.cab"+"?url="+(window.VET_Referrer?window.VET_Referrer:window.location.href)+"#Version=3,0,2,62"
			...
			str='<img src="'+VET_No_Plugin+'" width="'+width+'" height="'+height+'" border="0">'
			if(this.LN!=VET_Ln){
				if(VET_Dbg==1)MTSConsole(str,na)
...
function TriggerJS(){VET_NNtrgr="0"
	...
	var sp="https://components.viewpoint.com/adobe/MTSInstallers/MetaStream3.jar"+"?url="+(window.VET_Referrer?window.VET_Referrer:window.location.href),VET_Cv=2
